...
const Restaurants = () => {
  ...
  const [viewMode, setViewMode] = useState('all'); // 'all' or 'cuisine'
  ...
  return (
    <div className="pt-16 min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Search and Filters - Only show in 'all' mode */}
        {viewMode === 'all' && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {viewMode === 'all' && (
          <div className="mb-6">
            <p className="text-gray-600">
              {loading ? 'Loading...' : `Found ${restaurants.length} restaurants in Chandigarh`}
            </p>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            {Object.entries(groupRestaurantsByCuisine()).map(([cuisineName, cuisineRestaurants], cuisineIndex) => {
              ...
              return (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: cuisineIndex * 0.1 }}
                  className="space-y-6"
                >
                  {/* Cuisine Header */}
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-white/90 text-lg">
                          {cuisineRestaurants.length} restaurant{cuisineRestaurants.length !== 1 ? 's' : ''} available in Chandigarh
                        </p>
                      </div>
                    </div>
                  </div>
