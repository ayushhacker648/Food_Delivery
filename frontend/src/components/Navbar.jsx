          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/cart" className="relative">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative p-2 bg-white/80 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
              >
                ...
                {totalItems > 0 && (
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-2 -right-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs rounded-full h-6 w-6 flex items-center justify-center font-bold"
                  >
                    {totalItems}
                  </motion.span>
                )}
